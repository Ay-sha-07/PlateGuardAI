...
const base={Home:"Home",Scan:"Scan",History:"History",Card:"Card",Profile:"Profile",Language:"Language",SelectLanguage:"Choose language"};
...
const overrides: Partial<Record<LanguageCode, Record<string,string>>> = {
  ml:{Home:"ഹോം",Scan:"സ്കാൻ",History:"ചരിത്രം",Card:"കാർഡ്",Profile:"പ്രൊഫൈൽ",Language:"ഭാഷ",SelectLanguage:"ഭാഷ തിരഞ്ഞെടുക്കുക"},
  hi:{Home:"होम",Scan:"स्कैन",History:"इतिहास",Card:"कार्ड",Profile:"प्रोफ़ाइल",Language:"भाषा",SelectLanguage:"भाषा चुनें"},
  ta:{Home:"முகப்பு",Scan:"ஸ்கேன்",History:"வரலாறு",Card:"அட்டை",Profile:"சுயவிவரம்",Language:"மொழி",SelectLanguage:"மொழியைத் தேர்ந்தெடுக்கவும்"},
  ar:{Home:"الرئيسية",Scan:"مسح",History:"السجل",Card:"البطاقة",Profile:"الملف الشخصي",Language:"اللغة",SelectLanguage:"اختر اللغة"},
  es:{Home:"Inicio",Scan:"Escanear",History:"Historial",Card:"Tarjeta",Profile:"Perfil",Language:"Idioma",SelectLanguage:"Elegir idioma"},
  fr:{Home:"Accueil",Scan:"Scanner",History:"Historique",Card:"Carte",Profile:"Profil",Language:"Langue",SelectLanguage:"Choisir la langue"},
};
