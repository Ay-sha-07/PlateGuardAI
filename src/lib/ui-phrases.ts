...
export const PROFILE_PHRASES = [
  ...
  "Any other sensitivities (optional)",
  "List anything not covered above — treated with the same priority as selected allergens.",
  "Anything not listed above that should influence food advice.",
  "Not true allergies — only flagged when relevant to comfort or tolerance.",
  "e.g. mango, chickpea flour, specific spice blends",
  "e.g. gout, history of kidney stones, recent surgery",
  "e.g. high histamine foods, nightshades, artificial sweeteners",
  ...
  // Option labels (values stay English in storage; labels are display-only)
  "Child (under 13)",
  "Teen (13–17)",
  "Adult (18–64)",
  "Senior (65+)",
  ...
  "Celiac disease (strict zero-gluten)",
  ...
  "Digestive",
  "Other",
  "Diabetes (see detail below)",
  "Thyroid disorder",
  "PCOS",
  "Hypertension (see detail below)",
  "High cholesterol",
  "Chronic kidney disease (see detail below)",
  "Kidney stones",
  "GERD / acid reflux",
  ...
  "Profile photo updated.",
  "Could not upload the photo.",
  "Name for the new profile (e.g. a family member's name)",
  "Delete the profile",
  "This can't be undone.",
  "saved — scans now weigh their full health picture.",
  "ft",
  "in",
  "cm",
  "Search allergens…",
